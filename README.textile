...
h3. setup configuration files - make any necessary edits to these if the defaults don't work for you

# mv config/database.example.yml config/database.yml
# mv config/newrelic.example.yml config/newrelic.yml
...
Spot.Us should now be running on your computer at the URL "http://localhost:3000":http://localhost:3000
